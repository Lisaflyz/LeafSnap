...
public class Camera2BasicFragment extends Fragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(imageDir, fileName);//父文件，子文件名
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.identify: {
               Intent intent = new Intent(activity, SnapActivity.class);
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            //无这句话时已通知图库更新了
            activity.getApplicationContext().sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE,
                    Uri.parse("file://" + mFile.getAbsolutePath())));
            Log.i(TAG, "已成功保存图片至图库");
